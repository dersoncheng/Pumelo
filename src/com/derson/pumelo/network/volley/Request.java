...
import com.derson.pumelo.network.volley.toolbox.HttpRequestParams;
...
public abstract class Request<T> implements Comparable<Request<T>> {
    ...
    /**
     * Return the method for this request.  Can be one of the values in {@link }.
     */
     ...
     * @see com.derson.pumelo.network.volley.Request#setTag(Object)
     */
     ...
     */
    @Deprecated
    protected HttpRequestParams getPostParams() throws AuthFailureError {
        return getParams();
    }
    ...
    public byte[] getPostBody() throws AuthFailureError {
        ...
        HttpRequestParams postParams = getPostParams();
        if (postParams != null && postParams.urlParams.size() > 0) {
            return encodeParameters(postParams.urlParams, getPostParamsEncoding());
        }
        return null;
    }
     ...
     * @throws AuthFailureError in the event of auth failure
     */
    protected HttpRequestParams getParams() throws AuthFailureError {
        return null;
    }
    ...
    public byte[] getBody() throws AuthFailureError {
        ...
        if (params != null && params.urlParams.size() > 0) {
            return encodeParameters(params.urlParams, getParamsEncoding());
        }
        return null;
    }
    ...
    /**
     * Returns the {@link Priority} of this request; {@link com.hupu.android.net.volley.Request.Priority#NORMAL} by default.
     */
     ...
     */
    abstract protected void deliverResponse(int methodId, T response);
     ...
     */
    public void deliverError(int methodId, VolleyError error) {
        if (mErrorListener != null) {
            mErrorListener.onErrorResponse(methodId, error);
        }
    }
