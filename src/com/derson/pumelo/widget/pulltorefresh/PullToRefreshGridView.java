 ...
 *******************************************************************************/
package com.derson.pumelo.widget.pulltorefresh;
...
public class PullToRefreshGridView extends PullToRefreshAdapterViewBase<GridViewWithHeaderAndFooter> {
	...
	public View addFooterView(Context cxt,int resId,String displayText) {
		View footer = View.inflate(cxt,  resId, null);
		((TextView)footer.findViewById(R.id.footer_text)).setText(displayText);
		mRefreshableView.addFooterView(footer);
		return footer;
	}
	
	public void removeFooterView(View footer) {
		if(mRefreshableView.getFooterViewCount() >0) {
